...
class Rout():
    def __init__(self, fpath, T, fpath_desty, fvedge_desty, fedge_desty, graph_store_name, degree_file, subpath, axes_file,  speed_file, true_path, sigma, eta, query_name):
        self.fpath = fpath
        self.hU = {}
        self.T = T
        self.sigma = sigma
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='V-BS')
    ...
    time_budget = 5000
    rout = Rout(fpath, time_budget, fpath_desty, fvedge_desty, fedge_desty, graph_store_name, degree_file, subpath, axes_file, speed_file, true_path, sigma, eta, query_name)
    rout.main()
