...
if __name__ == '__main__':
    ...
    pace_rout = PaceRout(fpath, time_budget, fpath_desty, fvedge_desty, fedge_desty, graph_store_name, degree_file, subpath, axes_file, speed_file, true_path, sigma, eta, query_name)
    pace_rout.main()
