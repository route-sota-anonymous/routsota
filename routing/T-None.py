...
class PaceRout():
    def __init__(self, fpath, T, fpath_desty, fvedge_desty, fedge_desty, graph_store_name, degree_file, subpath, axes_file,  speed_file, true_path, subpath_path, subpath_range, sigma, eta, query_name):
        self.fpath = fpath
        self.hU = {}
        self.T = T
        self.sigma = sigma
...
if __name__ == '__main__':
    ...
    pace_rout = PaceRout(fpath, time_budget, fpath_desty, fvedge_desty, fedge_desty, graph_store_name, degree_file, subpath, axes_file, speed_file, true_path, subpath_path, subpath_range, sigma, eta, query_name)
    pace_rout.main()
