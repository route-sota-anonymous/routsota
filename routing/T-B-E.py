...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='T-B-E')
    ...
    time_budget = 5000
    rout = Rout(fpath, time_budget, fpath_desty, fvedge_desty, fedge_desty, graph_store_name, degree_file, subpath, axes_file, speed_file, true_path, query_name)
    rout.main()
